  ...
  return (
    <div style={{ display: 'grid', placeItems: 'center', height: '115vh', fontFamily: "Sans-serif" }}>
      <div style={{ 
        ...
        <Link style={{ color: "#45586E", marginTop: "1vh", marginLeft: "-1vh", display: "flex", gap: "46vh" }} to="/">
          <ArrowBackIcon />
          <CloseIcon />
        </Link>
        <form onSubmit={handleSubmit}>
          <div style={{ color: "#84BED3", marginTop: "-4vh", marginLeft:"14vh" }}>
            <h1 style={{ marginTop: "1vh", marginLeft:  "-4vh" }}>Crear cuenta para ofrecer servicios</h1>
            <TextField
...
export default FormServiceUser;
